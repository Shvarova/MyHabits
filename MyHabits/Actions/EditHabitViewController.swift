...
class EditHabitViewController: UIViewController {
    ...
    private lazy var color = HabitsStore.shared.habits[index].color
    ...
    @objc func save() {
        ...
        let habit = Habit(name: text, date: date, trackDates: HabitsStore.shared.habits[index].trackDates, color: color)
    ...
    private func setupViews() {
        view.addSubviews([titleLabel, textField, colorLabel, colorLabel, colorButton, timeTitleLabel, chooseTimeLabel, timePicker, deleteButton])
        setupConstraints()
        textField.text = HabitsStore.shared.habits[index].name
        colorButton.backgroundColor = HabitsStore.shared.habits[index].color
        colorPicker.selectedColor = HabitsStore.shared.habits[index].color
        date = HabitsStore.shared.habits[index].date
        setTimeLabel()
